...
from .layers import (color_branches, colorbar, highlight_clade, legend, node_labels,
                     scale_bar, time_axis, tip_labels, tip_track)
...
__all__ = [
    ...
    "plot", "Figure", "Style",
    "color_branches", "tip_labels", "node_labels", "tip_track",
